...
import { ManagedIdentityEnvironmentVariableNames, ManagedIdentitySourceNames, HttpMethod, METADATA_HEADER_NAME, API_VERSION_QUERY_PARAMETER_NAME, RESOURCE_BODY_OR_QUERY_PARAMETER_NAME, ManagedIdentityIdType } from '../../utils/Constants.mjs';
